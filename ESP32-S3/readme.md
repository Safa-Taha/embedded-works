...
## 📌 Project Overview
This repository contains the complete hardware design files, schematics, and layouts for an ESP32-S3-MINI breakout and development board. The design is tailored for prototyping and embedded applications requiring Wi-Fi, Bluetooth LE 5, and ample general-purpose I/O (GPIO) routing with reliable power distribution.
...
## ⚙️ Fabrication & Manufacturing Specifications
If you are generating or reviewing production files for this board, use the following configuration guidelines:
* **Units:** Mils / Millimeters (Grid and track dimensions configured to standard imperial/metric mixed units, default tracks set to 10 mil).
* **Gerber Format:** High-resolution coordinate format (**2:5** or **4:5**) to ensure precise pad and clearance definitions for fine-pitch components.
